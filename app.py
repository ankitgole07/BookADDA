...
app.config["secret_key"]="c7be4374b8f6130a937531f9a68826bf"

#CONFIG MySQL
app.config['MYSQL_HOST'] = 'localhost'
app.config['MYSQL_USER'] = 'root'
app.config['MYSQL_PASSWORD'] = '2599'
...
def profile():
	...
	if result > 0:
		...
		return render_template('profile.html',profile=profile,booksold=booksold)
